...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="{{ mix('/bootstrap/bootstrap.min.css') }}">
        <link rel="stylesheet" href="{{ mix('/bootstrap/bootstrap-icons.css') }}">
        
        <link rel="stylesheet" href="{{ mix('/aos/aos.css') }}">
        ...
        <script src="{{ mix('/bootstrap/bootstrap.min.js') }}"></script>
        <script src="{{ mix('/aos/aos.js') }}"></script>
