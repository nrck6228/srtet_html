...
@push('script-datepicker')
    ...
    <script>
        ...
        $("#start_date01, #start_date02").datepicker({
            changeMonth: true,
            changeYear: true,
            //yearRange: '-80:+0',//EN
            dateFormat: 'dd/mm/yy',
        ...
        $('#start_date01, #start_date02').datepicker("setDate",currentDate );

        $("#end_date01, #end_date02").datepicker({
            changeMonth: true,
            changeYear: true,
        ...
        $('#end_date01, #end_date02').datepicker("setDate",currentDate );
    </script>
