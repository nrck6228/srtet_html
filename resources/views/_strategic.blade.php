...
@section('title', 'ยุทธศาสตร์ แผนปฏิบัติราชการ')
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">ยุทธศาสตร์ แผนปฏิบัติราชการ</li>
                    </ol>
                </nav>
            </div>
        </div>
        ...
        <article class="page--content">
            <div class="container">
                <div class="title--page justify-content-center">
                    <h2 class="page__title text--primary">ยุทธศาสตร์ แผนปฏิบัติราชการ</h2>
                </div>
