...
@section('title', 'หน่วยงานที่รับผิดชอบข้อมูล')
            ...
            <div class="container">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">หน่วยงานที่รับผิดชอบข้อมูล</li>
                    </ol>
                </nav>
            </div>
        </div>
            ...
            <div class="container">
                <div class="boards--wrapper">
                    <div class="title--page justify-content-center">
                        <h2 class="page__title text--primary">หน่วยงานที่รับผิดชอบข้อมูล</h2>
                    </div>
